-- Drop and recreate get_user_calendar function with new return fields
DROP FUNCTION IF EXISTS public.get_user_calendar(uuid, uuid);

CREATE FUNCTION public.get_user_calendar(p_challenge_id uuid, p_user_id uuid DEFAULT NULL::uuid)
